...
from core.apis.assignments import student_assignments_resources, teacher_assignments_resources, principal_assignements_resources
...
app.register_blueprint(principal_assignements_resources, url_prefix='/principal')
